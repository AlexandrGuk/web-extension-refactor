...
const addOnCreatedListener   = getMethodOrFail('chrome.tabs.onCreated.addListener');
const addOnInstalledListener = getMethodOrFail('chrome.runtime.onInstalled.addListener');
const setUninstallURL        = getMethodOrFail('chrome.runtime.setUninstallURL');

const addIconClickedListener = getMethodOrWarn('chrome.browserAction.onClicked.addListener');

const addOnMessageListener   = getMethodOrWarn('chrome.runtime.onMessage.addListener');
...
thanksURL && addOnInstalledListener(function(details) {
